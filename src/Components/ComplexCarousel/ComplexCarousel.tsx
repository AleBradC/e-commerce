...
import { ComplexCarouselType } from '../../types'
...
export const ComplexCarousel: React.FC<ComplexCarouselProps> = ({
  ...
  return (
    <Slider
      ...
      sliders={complexCarouselSliders.map((complexCarouselItem, index) => (
        <Slide key={index}>
          <Container>
            <Body>
              ...
              <ImageContainer>
                <ImageLogo src={complexCarouselItem.imageLogo} />
              </ImageContainer>
              <Content>{complexCarouselItem.content}</Content>
