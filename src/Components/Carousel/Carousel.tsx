...
export const Carousel: React.FC<CarouselProps> = ({ carouselSliders, carouselActiveIndex, setCarouselActiveIndex }) => {
  ...
  return (
    <Slider
      ...
      sliders={carouselSliders.map((carouselItem, index) => (
        <Slide key={index}>
          <Container>
            <Body>
              <TopContent> {carouselItem.topContent} </TopContent>
              <MiddleContent> {carouselItem.middleContent} </MiddleContent>
              <BottomContent> {carouselItem.bottomContent} </BottomContent>
              <CarouselImage src={carouselItem.image} />
            </Body>
            <Footer>
              <ProductDetails>
                ...
                <ProductBrand> {carouselItem.productBrand} </ProductBrand>
                <ProductName> {carouselItem.productName} </ProductName>
